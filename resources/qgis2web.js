...
map.getView().fit([8816849.340916, 778095.578284, 9170712.541058, 1009265.373556], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Road Network & Waterways of Sri Lanka</h2>';
        return titleElement;
    })(),
